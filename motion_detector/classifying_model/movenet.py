# This module is taken from a Tensorflow example repository to use the functionality in the project.
...
"""This is code to run the pose-estimation algorithm using the TFLite Movenet Model"""
